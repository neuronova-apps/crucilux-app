(() => {
  ...
  const wordHelp = {
    SOL: {
      hints: [
        'Piensa en un astro que produce su propia luz, no en un planeta.',
    ...
    MAR: {
      hints: [
        'Busca una gran masa de agua salada; no es un río ni un lago.',
        'La palabra empieza por M.',
    ...
    LUZ: {
      hints: [
        'No es un objeto: es aquello que hace visibles los objetos a nuestros ojos.',
        'La palabra empieza por L.',
    ...
    LUNA: {
      hints: [
        'Piensa en el cuerpo celeste que acompaña a la Tierra y vemos especialmente de noche.',
        'La palabra empieza por L.',
    ...
    ROCA: {
      hints: [
        'Es un material natural sólido que puedes encontrar en montañas, suelos y acantilados.',
        'La palabra empieza por R.',
        'La última letra es A.'
      ],
    ...
    AGUA: {
      hints: [
        'Es una sustancia esencial que encontramos en ríos, lagos y mares.',
        'La palabra empieza por A.',
        'La última letra también es A.'
      ],
      explanation: 'Agua encaja porque es el líquido presente en ríos, lagos y mares al que se refiere la pista.'
    },
    LIBRO: {
      hints: [
        'Piensa en algo que se lee y reúne contenido escrito en páginas.',
        'La palabra empieza por L.',
    ...
    IDEA: {
      hints: [
        'Es algo que puede surgir en la mente antes de convertirse en una propuesta o un plan.',
    ...
    RISA: {
      hints: [
        'Piensa en una expresión espontánea asociada con diversión o alegría.',
        'La palabra empieza por R.',
        'La última letra es A.'
      ],
  ...
  function resetFeedback() {
    ...
    setFeedback(
      'neutral',
      'Ayuda gradual',
      'Comprueba la palabra para recibir orientación sobre tu intento o usa “Pista gradual” cuando necesites una ayuda adicional.'
    );
  }
  ...
  function evaluateAttempt() {
    ...
    if (missing) {
      setFeedback(
        'tip',
        'Completa el patrón',
        `Faltan ${missing} ${missing === 1 ? 'letra' : 'letras'} en la palabra activa. Usa los cruces ya resueltos y vuelve a comprobar cuando todas las casillas tengan una letra.`
      );
      return;
    }
    ...
    setFeedback(
      'review',
      'Revisa el patrón',
      `Tienes ${correctPositions} de ${word.length} letras en la posición correcta. Las casillas marcadas necesitan revisión; vuelve a relacionar la pista con la palabra o solicita una pista gradual.`
    );
  }
  ...
  function showHint() {
    ...
    setFeedback(
      'hint',
      `Pista ${hintIndex + 1} de ${help.hints.length}`,
      `${help.hints[hintIndex]}${suffix}`
    );
  }
  ...
  board.addEventListener('keydown', event => {
    if (event.key === 'Enter') {
      queueMicrotask(evaluateAttempt);
    }
  });
